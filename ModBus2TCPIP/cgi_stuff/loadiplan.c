...
int main(int argc, char* argv[])
{
	...
	char lan_type[10],lan_ip[50],lan_mask[50],lan_gateway[50],header_background_color[10],header_logo_background_color[10],navigation_color[10],server_address[100],command[100],temp[10];
	...
	FILE* contactfile=fopen("/home/etc/customer.profile.contact", "r");
	FILE* aboutfile=fopen("/home/etc/customer.profile.about", "r");
	...
	printf("   clear: both;\n");
	printf("   padding: 0px;\n");
	printf("   background-color: #696969;\n");
	printf("   color: white;\n");
...
/*	printf("table, th, td {");
	...
	if(!disable_about && aboutfile!=NULL)
		puts("		<li><a href=\"#\" data-target=\"about\">About</a></li>");
	if(!disable_contact && contactfile!=NULL)
		puts("        	<li><a href=\"#\" data-target=\"contact\">Contact</a></li>");

	puts("        <li><a href=\"#\" data-target=\"LO\">Logout</a></li>");
...
/*	puts("  <tr> ");
	...
	puts("            <div id=\"logout\" hidden>");
	puts("               <!--<blockquote>-->");
	puts("               <big>Web Logout</big>");
	puts("               <table border=\"0\" width=\"550\" cellspacing=\"0\" cellpadding=\"0\">");
	puts("                  <tbody>");
	puts("                     <tr>");
	puts("                        <td>");
	...
	puts("                     <tr>");
	puts("                        <td><small>");
	puts("                           This page allows User to logout.....");
	puts("                           </small>");
	puts("                        </td>");
	puts("                     </tr>");
	puts("                     <tr>");
	...
	puts("                  </tbody>");
	puts("               </table>");
	puts("               <form action=\"logout.cgi\" method=\"GET\">");
	puts("                  <table border=\"0\" width=\"550\" cellspacing=\"0\" cellpadding=\"0\">");
	puts("                     <tbody>");
	puts("                        <tr>");
	puts("                           <td>&nbsp;</td>");
	...
	puts("                           <td></td>");
	puts("                           <td>");
	puts("                              <input type=\"submit\" name=\"save_gw_server\" value=\"Logout\" >");
	puts("                              &nbsp;&nbsp;");
	...
	if (aboutfile!=NULL){
		while (fgets(command, sizeof(command), aboutfile)) {
			printf("%s",command);
		}
		fclose(aboutfile);
	}
...
#if 1
	if (contactfile!=NULL){
		while (fgets(command, sizeof(command), contactfile)) {
			printf("%s",command);
		}
		fclose(contactfile);
	}
